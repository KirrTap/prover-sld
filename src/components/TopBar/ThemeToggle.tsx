...
export const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-600 w-10 h-10 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors"
